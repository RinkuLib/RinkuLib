...
/// <summary>
/// Pins the documented whitespace contract for each marker position. A space on only one side collapses
/// cleanly; spaces on both sides are preserved by the renderer.
/// </summary>
