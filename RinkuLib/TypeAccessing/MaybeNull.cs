...
/// <summary>Used to throw if the parsed value result in a null</summary>
public readonly struct Optional<T>([NotNull][NoName] T value) : IWrapping<Optional<T>, T> where T : class {
    /// <summary>Indicate if the item has a value</summary>
    public bool HasValue => Value is not null;
    /// <summary>The underlying value</summary>
    public readonly T? Value = value;
...
/// <summary>Used to throw if the parsed value result in a null</summary>
public readonly struct Single<T>([NotNull][NoName] T value) : IWrapping<Single<T>, T> where T : class {
    /// <summary>The underlying value</summary>
    public readonly T Value = value;
    /// <inheritdoc/>
