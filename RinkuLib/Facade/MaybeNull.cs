...
/// <summary>
/// A result shape for exactly one result. No result and a second result both throw. When the element itself
/// folds several rows, those rows still form one result.
/// </summary>
