...
public abstract class SpecialHandler : IQuerySegmentHandler {
    ...
    /// <summary>Returns learned provider metadata owned by this handler to the inferred strategy.</summary>
    /// <param name="inferred">The current inferred strategy supplied by the parameter services.</param>
    public virtual void ResetCache(DbParamInfo inferred) => IsCached = inferred.IsCached;
}
/// <summary>
...
public class MultiVariableHandler(string ParameterName) : SpecialHandler {
    ...
    public DbParamInfo CachedParam = InferredDbParamCache.Instance;
    /// <summary>
