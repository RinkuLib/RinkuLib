...
Rinku is a micro-ORM built directly on ADO.NET. You write the SQL and choose the result type. This page gives a quick look at the main features. Follow any link for the related guide.
